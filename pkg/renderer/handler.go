...
func (a app) Directory(w http.ResponseWriter, request provider.Request, content map[string]interface{}, message renderer.Message) {
...
func (a app) File(w http.ResponseWriter, request provider.Request, content map[string]interface{}, message renderer.Message) {
